...
@section('meta_tags')
    ...
    <meta property="twitter:description" property="og:description" itemprop="name" content="{{ blogInfo()->blog_description }}"/>
               ...
               <article class="card article-card">
                  <a href="{{ route('read_post', single_latest_post()->post_slug) }}">
                     <div class="card-image">
                        ...
                        <img loading="lazy" decoding="async" src="/storage/images/post_images/{{single_latest_post()->featured_image}}" alt="{{single_latest_post()->post_title}}" class="w-100">
                     </div>
                  </a>
          ...
          <div class="col-md-6 mb-4">
             <article class="card article-card article-card-sm h-100">
                ...
                <div class="card-body px-0 pb-0">
                   ...
                   <h2><a class="post-title" href="{{ route('read_post', $item->post_slug) }}">{{ $item->post_title}}</a>
                   </h2>
