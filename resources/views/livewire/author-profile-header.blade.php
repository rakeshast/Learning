<div>
    <div class="row align-items-center">
        ...
        <div class="col-auto d-md-flex">
          <input type="file" name="file" id="file" value="Change Picture" class="d-none" onchange="this.dispatchEvent(new Event('input'))">
          <a href="#" class="btn btn-primary" onclick="event.preventDefault();document.getElementById('file').click();">
