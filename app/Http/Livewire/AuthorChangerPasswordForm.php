...
class AuthorChangerPasswordForm extends Component
{
            ...
            'current_password' => [
                'required', function($attribute, $value, $fail){
                    if (!Hash::check($value, User::find(auth('web')->id())->password)) {
                        return $fail(__('The current password is incurrect'));
                    }
                },
            ],
            'new_password' => 'required|min:5|max:25|different:current_password',
            'confirm_new_password' => 'same:new_password'
        ],[
            'current_password.required' => 'Enter your current password',
            'new_password.required' => 'Enter new password',
            'confirm_new_password.same' => 'The conform new password must be equal to the new password',
    ...
    {
        return view('livewire.author-changer-password-form');
    }
}
